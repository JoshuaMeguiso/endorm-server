    ...
    <>
        ...
        <>
          {!transactions && (
            <div className="tenant-details">
              <p>
                <strong>No Statement of Account</strong>
              </p>
            </div>
          )}
        </>
      ...
      {transactions && (
        <>
          <div className="tenant-details">
            <p>
              <strong>Tenant Name &emsp;&emsp;&emsp;&emsp;:&emsp;</strong>
            ...
            <p>
              <strong>Period Covered&emsp;&emsp;&emsp; &nbsp;:&emsp;</strong>
            ...
            <p>
              <strong>Water Charge&emsp;&emsp;&emsp;&emsp;:&emsp;</strong>₱{" "}
              {parseFloat(transactions.water_Charge).toFixed(2)}
            </p>
            <p>
              <strong>Previous Reading&emsp;&emsp; :&emsp;</strong>
              {transactions.previous_Reading} KWH
            </p>
            <p>
              <strong>Present Reading&emsp;&emsp;&ensp; :&emsp;</strong>
              {transactions.present_Reading} KWH
            </p>
            <p>
              <strong>Total Consume &emsp;&emsp;&emsp; :&emsp;</strong>
              {transactions.total_Consume} KWH
            </p>
            <p>
              <strong>Room Consume&emsp;&emsp;&emsp;:&emsp;</strong>₱{" "}
              {parseFloat(transactions.room_Consume).toFixed(2)}
            </p>
            <p>
              <strong>Individual Consume&ensp; :&emsp;</strong>₱{" "}
              {parseFloat(transactions.individual_Consume).toFixed(2)}
            </p>
            <p>
              <strong>Total Amount&emsp;&emsp;&emsp;&emsp; :&emsp;</strong>₱{" "}
